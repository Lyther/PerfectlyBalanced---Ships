[b][size=20]Perfectly Balanced - Ships[/size][/b]

The development version of this mod is posted on [url=https://github.com/Lyther/PerfectlyBalanced---Ships]GitHub[/url]. If you want to play the latest version instead of the stable version, please follow the repo and use `git pull` to get the latest commit.

(i.e., Not balanced at all!)
...
[size=16][b]How to Unlock the New Content[/b][/size]
...
[size=16][b]Updates and Compatibility[/b][/size]
...
[quote]For example, modifications that make all ship behavior modes manually controllable during combat.[/quote]
...
[b][size=20]意识流平衡：舰船[/size][/b]

此MOD的开发版本将在[url=https://github.com/Lyther/PerfectlyBalanced---Ships]GitHub[/url]进行实时更新，如果您想游玩最新的开发版本而非稳定版本，可以通过GitHub仓库的`git pull`获取最新的commit。
